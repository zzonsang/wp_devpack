...
function integral_theme_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section( 'integral_default_header_section' , array(
            ...
            'priority'    => 120,
            'description' => __( 'This section controls the default header on the homepage of your website when the One-page Layout Template has not been configured. For instructions on how to configure your homepage go to <a href="themes.php?page=integral-welcome">APPEARANCE > Getting Started with Integral</a>.', 'integral' ),
	) );
